...
for (let i = 66; i < parsedContents.length; i++) {
    var page = 0;
    ...
    while (hasMorePages) {
        ...
        var contents = fs.writeFileSync("./truDataOutputWednesdayTWO_00" + i + "_" + page + ".json", JSON.stringify(nytData));
        sleep(5000);
    }
}
